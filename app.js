...
// Добавяме стъб теми за останалите от 6 до 15
for (let i = 6; i <= 15; i++) {
  TOPICS_DATA.topics.push({
    id: i,
    title: `Тема ${i} - В процес на разработка`,
    theory: '<div class="topic-section"><p>Това съдържание ще бъде добавено скоро...</p></div>',
    flashcards: [],
    quiz: [],
    examples: [],
    links: []
